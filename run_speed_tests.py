...
setups = [
    ...
    "from mom.codec._alt_bitcoin_base58 import b58encode_bitcoin; import os; b = os.urandom(3079)",
    ...
    "from mom.codec._alt_bitcoin_base58 import b58decode_bitcoin; from mom.codec.base58 import b58encode; import os; b = b58encode(os.urandom(60))",
    ...
    "from mom.codec._alt_bitcoin_base58 import b58encode_bitcoin; import os; b = os.urandom(60)",
    None,
